...
<component v-if="mapComponent" :is="mapComponent" v-model:checked="checked" />
...
<component v-if="mapComponent" :is="mapComponent" v-model:checked="checked" disabled />
...
<component v-if="mapComponent" :is="mapComponent" v-model:checked="checked" checkedInfo="开" uncheckedInfo="关" />
