...
onMounted(()=>{
    ...
    // })
     import('../../../packages/timeline/Timeline.vue').then(module => {
      mapComponent.value = module.default
    })
...
<component v-if="mapComponent" :is="mapComponent"  :timeline-data="timelineData" />
...
<component v-if="mapComponent" :is="mapComponent"  :timeline-data="timelineData" line-style="dashed" />
